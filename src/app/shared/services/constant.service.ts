...
export class ConstantService {
    ...
    public static PERM_NEGOCIOS_ADMIN_LECTURA             = "gestionar-negocios-admin-lectura";
    public static PERM_NEGOCIOS_ADMIN_ESCRITURA             = "gestionar-negocios-admin-escritura";
